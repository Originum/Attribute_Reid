...
class ResNet50_single(nn.Module):
    def __init__(self, class_num):
        super(ResNet50_single, self).__init__()
        self.model_name = 'resnet50_single'
        ...
        self.num_ftrs = 2048
        num_bottleneck = 512
        self.classifier = ClassBlock(self.num_ftrs, self.class_num, num_bottleneck)
